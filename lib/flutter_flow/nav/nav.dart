...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? SplashScreenWidget() : LoginPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => MeditationPage2Widget(),
        ),
        FFRoute(
          name: 'MeditationHomePage',
          path: '/meditationHomePage',
          builder: (context, params) => MeditationHomePageWidget(),
        ),
        FFRoute(
          name: 'MeditationPage3',
          path: '/meditationPage3',
          builder: (context, params) => MeditationPage3Widget(),
        ),
        FFRoute(
          name: 'UserSignUp',
          path: '/userSignUp',
        ...
        FFRoute(
          name: 'DoctorsSignUp',
          path: '/doctorsSignUp',
          builder: (context, params) => DoctorsSignUpWidget(),
        ),
        FFRoute(
          name: 'DoctorProfile',
          path: '/doctorProfile',
        ...
        FFRoute(
          name: 'EditPsychology',
          path: '/editPsychology',
          builder: (context, params) => EditPsychologyWidget(),
        ),
        FFRoute(
          name: 'PsychologySignUp',
          path: '/psychologySignUp',
          builder: (context, params) => PsychologySignUpWidget(),
        ),
        FFRoute(
          name: 'PsychologyProfile',
          path: '/psychologyProfile',
          builder: (context, params) => PsychologyProfileWidget(),
        ),
        FFRoute(
          name: 'EditDoctor',
          path: '/editDoctor',
        ...
        FFRoute(
          name: 'DoctorHomePage',
          path: '/doctorHomePage',
          builder: (context, params) => DoctorHomePageWidget(),
        ),
        FFRoute(
          name: 'UserHomePage',
          path: '/userHomePage',
        ...
        FFRoute(
          name: 'YourRequests',
          path: '/yourRequests',
          builder: (context, params) => YourRequestsWidget(),
        ),
        FFRoute(
          name: 'PsychologyHome',
          path: '/psychologyHome',
          builder: (context, params) => PsychologyHomeWidget(),
        ),
        FFRoute(
          name: 'ChatPageUsers',
          path: '/chatPageUsers',
        ...
        FFRoute(
          name: 'AllChatsUsers',
          path: '/allChatsUsers',
          builder: (context, params) => AllChatsUsersWidget(),
        ),
        FFRoute(
          name: 'AllChatsPsychology',
          path: '/allChatsPsychology',
          builder: (context, params) => AllChatsPsychologyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => DoctorNotificationsPageWidget(),
        ),
        FFRoute(
          name: 'PsychologyNotificationsPage',
          path: '/psychologyNotificationsPage',
          builder: (context, params) => PsychologyNotificationsPageWidget(),
        ),
        FFRoute(
          name: 'DraftNotificationsPage',
          path: '/draftNotificationsPage',
          builder: (context, params) => DraftNotificationsPageWidget(),
        ),
        FFRoute(
          name: 'UserAccountInfo',
          path: '/userAccountInfo',
          builder: (context, params) => UserAccountInfoWidget(),
        ),
        FFRoute(
          name: 'DoctorAccountInfo',
          path: '/doctorAccountInfo',
          builder: (context, params) => DoctorAccountInfoWidget(),
        ),
        FFRoute(
          name: 'PsychologyAccountInfo',
          path: '/psychologyAccountInfo',
          builder: (context, params) => PsychologyAccountInfoWidget(),
        ),
        FFRoute(
          name: 'UserAccessibility',
          path: '/userAccessibility',
          builder: (context, params) => UserAccessibilityWidget(),
        ),
        FFRoute(
          name: 'DoctorAccessibility',
          path: '/doctorAccessibility',
          builder: (context, params) => DoctorAccessibilityWidget(),
        ),
        FFRoute(
          name: 'PsychologyAccessibility',
          path: '/psychologyAccessibility',
          builder: (context, params) => PsychologyAccessibilityWidget(),
        ),
        FFRoute(
          name: 'UserChatSettings',
          path: '/userChatSettings',
          builder: (context, params) => UserChatSettingsWidget(),
        ),
        FFRoute(
          name: 'PsychologyChatSettings',
          path: '/psychologyChatSettings',
          builder: (context, params) => PsychologyChatSettingsWidget(),
        ),
        FFRoute(
          name: 'UserRewards',
          path: '/userRewards',
        ...
        FFRoute(
          ...
          builder: (context, params) => FavoriteDoctorsWidget(),
        ),
        FFRoute(
          name: 'FavoriteStudents',
          path: '/favoriteStudents',
          builder: (context, params) => FavoriteStudentsWidget(),
        ),
        FFRoute(
          name: 'UserNotificationSettings',
          path: '/userNotificationSettings',
          builder: (context, params) => UserNotificationSettingsWidget(),
        ),
        FFRoute(
          name: 'DoctorNotificationSettings',
          path: '/doctorNotificationSettings',
          builder: (context, params) => DoctorNotificationSettingsWidget(),
        ),
        FFRoute(
          name: 'PsychologyNotificationSettings',
          path: '/psychologyNotificationSettings',
          builder: (context, params) => PsychologyNotificationSettingsWidget(),
        ),
        FFRoute(
          name: 'UserRestrictedAccounts',
          path: '/userRestrictedAccounts',
          builder: (context, params) => UserRestrictedAccountsWidget(),
        ),
        FFRoute(
          name: 'TermsOfService',
          path: '/termsOfService',
        ...
        FFRoute(
          ...
          builder: (context, params) => UserPaymentMethodsWidget(),
        ),
        FFRoute(
          name: 'DoctorPaymentMethods',
          path: '/doctorPaymentMethods',
          builder: (context, params) => DoctorPaymentMethodsWidget(),
        ),
        FFRoute(
          name: 'IncomeEarned',
          path: '/incomeEarned',
          builder: (context, params) => IncomeEarnedWidget(),
        ),
        FFRoute(
          name: 'DoctorCertificate',
          path: '/doctorCertificate',
          builder: (context, params) => DoctorCertificateWidget(),
        ),
        FFRoute(
          name: 'DoctorBadges',
          path: '/doctorBadges',
          builder: (context, params) => DoctorBadgesWidget(),
        ),
        FFRoute(
          name: 'DoctorLanguages',
          path: '/doctorLanguages',
          builder: (context, params) => DoctorLanguagesWidget(),
        ),
        FFRoute(
          name: 'PsychologyLanguages',
          path: '/psychologyLanguages',
          builder: (context, params) => PsychologyLanguagesWidget(),
        ),
        FFRoute(
          name: 'PsychologyBadges',
          path: '/psychologyBadges',
          builder: (context, params) => PsychologyBadgesWidget(),
        ),
        FFRoute(
          name: 'PsychologyID',
          path: '/psychologyID',
          builder: (context, params) => PsychologyIDWidget(),
        ),
        FFRoute(
          name: 'SuccessPageCopy',
          path: '/successPageCopy',
          builder: (context, params) => SuccessPageCopyWidget(),
        ),
        FFRoute(
          name: 'psychbadges',
          path: '/psychbadges',
          builder: (context, params) => PsychbadgesWidget(),
        )
