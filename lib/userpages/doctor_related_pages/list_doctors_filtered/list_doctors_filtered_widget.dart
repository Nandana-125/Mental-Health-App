...
class ListDoctorsFilteredWidget extends StatefulWidget {
  const ListDoctorsFilteredWidget({
    ...
    String? filterSpec,
    String? filterExp,
  })  : this.drLanguage = drLanguage ?? 'all',
        this.filterNation = filterNation ?? 'all',
        this.filterGender = filterGender ?? 'all',
        this.filterSpec = filterSpec ?? 'all',
        this.filterExp = filterExp ?? 'all';
...
class _ListDoctorsFilteredWidgetState extends State<ListDoctorsFilteredWidget> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0x6F131619),
        appBar: AppBar(
          backgroundColor: Color(0x10131619),
