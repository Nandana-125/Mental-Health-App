                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                            ...
                                                                                            color: valueOrDefault<Color>(
                                                                                              (columnMessagingDepthRecord.deliveredMail == widget.userEmail) && (columnMessagingDepthRecord.receivedMail == currentUserEmail) ? FlutterFlowTheme.of(context).primaryBtnText : Color(0xD4010000),
